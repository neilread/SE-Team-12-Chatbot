...
describe("textToPaper()", () =>
{
    ...
    {
        expect(scrape.Paper.textToPaper("COMP500 Programming 1 (15 points)")).toEqual(new scrape.Paper("COMP500", "Programming 1", 5, 15));
    });
    
    it("should throw an error if text is not a string", () =>
    {
        expect(() => scrape.Paper.textToPaper(2.5)).toThrow(new Error("text is not of type string"));
    });
});
...
describe("getPapersForMajor()", () =>
{
    ...
    {
        let papers = scrape.getPapersForMajor("Software Development", (papers) =>        
        {
            expect(scrape.Paper.getCodes(scrape.Degree.getPapers(papers))).toEqual(["COMM501", "COMP500", "COMP501", "COMP502", "COMP503", "ENEL504", "INFS500", "MATH500", "MATH501", "MATH502", "STAT500",
...
describe("getCourseForMajor()", () =>
{
    it("should return a list of papers that meet the requirements for the specified major and degree.", (done) =>
    {
        ...
        {
            expect(scrape.Paper.getCodes(papers).sort()).toEqual(["COMM501", "COMP500", "COMP501", "COMP502", "COMP503", "ENEL504",
             "INFS500", "MATH500", "COMP600", "COMP602", "COMP603", "INFS600", "INFS601", "COMP604", "COMP704", 
             "COMP719", "ENSE701", "COMP713", "MATH501", "MATH502", "STAT500", "INFS602", "COMP721"].sort());
